//
//  Example0331Group110Cell.m
//  Example
//
//  Created by Xezun on 2023/8/20.
//

#import "Example0331Group110Cell.h"
#import "Example0331Group110CellViewModel.h"

@interface Example0331Group110Cell ()
@property (nonatomic, strong) UILabel *textLabel;
@property (nonatomic, strong) UILabel *detailTextLabel;
@end

@implementation Example0331Group110Cell

+ (void)load {
    XZMocoa(@"https://mocoa.xezun.com/examples/03/31/collection/110").viewClass = self;
}
...
- (void)prepareForViewModel:(Example0331Group110CellViewModel *)viewModel {
