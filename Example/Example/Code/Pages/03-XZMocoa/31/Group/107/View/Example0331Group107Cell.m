//
//  Example0331Group107Cell.m
//  Example
//
//  Created by Xezun on 2023/8/20.
//

#import "Example0331Group107Cell.h"
#import "Example0331Group107CellViewModel.h"

@interface Example0331Group107Cell ()
@property (nonatomic, strong) UILabel *textLabel;
@property (nonatomic, strong) UILabel *detailTextLabel;
@end

@implementation Example0331Group107Cell

+ (void)load {
    XZMocoa(@"https://mocoa.xezun.com/examples/03/31/collection/107").viewClass = self;
}
...
- (void)prepareForViewModel:(Example0331Group107CellViewModel *)viewModel {
