...
- (void)testEncoding {
    ...
    XZLog(@"1.1: %@", [data1 xz_hexEncodedString]);
    XZLog(@"1.2: %@", [data1 xz_hexEncodedStringWithCharacterCase:(XZCharacterLowercase)]);
    XZLog(@"1.3: %@", [NSString xz_stringHexEncodedWithBytes:string1.UTF8String length:[string1 lengthOfBytesUsingEncoding:(NSUTF8StringEncoding)] characterCase:(XZCharacterUppercase)]);
    
    NSString *string2 = @"585A4B697420E69599E7A88B";
    NSData *data2 = [NSData xz_dataWithHexEncodedString:string2];
