...
@implementation Example05YYWeiboPictureMetadata
...
@implementation Example05YYWeiboPicture
+ (NSDictionary *)modelCustomPropertyMapper {
    return @{@"picID" : @"pic_id",
             @"keepSize" : @"keep_size",
             @"photoTag" : @"photo_tag",
...
@implementation Example05YYWeiboURL
+ (NSDictionary *)modelCustomPropertyMapper {
...
@implementation Example05YYWeiboUser
+ (NSDictionary *)modelCustomPropertyMapper {
    return @{@"userID" : @"id",
             @"idString" : @"idstr",
             @"genderString" : @"gender",
...
@implementation Example05YYWeiboStatus
+ (NSDictionary *)modelCustomPropertyMapper {
    return @{@"statusID" : @"id",
             @"createdAt" : @"created_at",
...
+ (NSDictionary *)modelContainerPropertyGenericClass {
    return @{@"picIds" : [NSString class],
             @"picInfos" : [Example05YYWeiboPicture class],
             @"urlStruct" : [Example05YYWeiboURL class]};
}
YYModelSynthCoderAndHash
@end
