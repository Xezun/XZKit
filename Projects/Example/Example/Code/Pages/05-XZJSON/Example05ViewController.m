    ...
    switch (indexPath.section) {
        ...
        case 1: {
            switch (indexPath.row) {
                ...
                case 1: {
                    text = [[XZObjcClass classWithClass:[Example05Model class]] description];
                    break;
                }
                case 2: {
        ...
        case 2: {
            switch (indexPath.row) {
                case 0: {
                    text = [[XZObjcClass classWithClass:[Example05Human class]] description];
                    break;
                }
                case 1: {
                    text = [[XZObjcClass classWithClass:[Example05Teacher class]] description];
                    break;
                }
                case 2: {
                    text = [[XZObjcClass classWithClass:[Example05Student class]] description];
                    break;
                }
                case 3: {
                    _teachers = [XZJSON decode:_response.teachers options:(NSJSONReadingAllowFragments) class:[Example05Teacher class]];
                    text = [XZJSON model:_teachers describeWithIndent:0];
                    break;
                }
                case 4: {
                    if (!_teachers) {
        ...
        case 3: {
            switch (indexPath.row) {
                ...
                case 1: {
                    ...
                    text = [XZJSON model:teachers describeWithIndent:0];
                    break;
                }
                case 2: {
                    break;
