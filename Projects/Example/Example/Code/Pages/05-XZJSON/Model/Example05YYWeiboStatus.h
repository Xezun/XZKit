...
@class Example05YYWeiboUser;

@interface Example05YYWeiboStatus : NSObject <NSCoding, NSCopying>
@property (nonatomic, assign) uint64_t statusID;
@property (nonatomic, strong) NSString *idstr;
@property (nonatomic, strong) NSString *mid;
@property (nonatomic, strong) NSString *rid;
@property (nonatomic, strong) NSDate *createdAt;
@property (nonatomic, strong) Example05YYWeiboUser *user;
...
@interface Example05YYWeiboPictureMetadata : NSObject <NSCoding, NSCopying>
...
@interface Example05YYWeiboPicture : NSObject <NSCoding, NSCopying>
@property (nonatomic, strong) NSString *picID;
@property (nonatomic, strong) NSString *objectID;
@property (nonatomic, assign) int photoTag;
@property (nonatomic, assign) BOOL keepSize;
@property (nonatomic, strong) Example05YYWeiboPictureMetadata *thumbnail;
@property (nonatomic, strong) Example05YYWeiboPictureMetadata *bmiddle;
@property (nonatomic, strong) Example05YYWeiboPictureMetadata *middlePlus;
@property (nonatomic, strong) Example05YYWeiboPictureMetadata *large;
@property (nonatomic, strong) Example05YYWeiboPictureMetadata *largest;
@property (nonatomic, strong) Example05YYWeiboPictureMetadata *original;
@end

@interface Example05YYWeiboURL : NSObject <NSCoding, NSCopying>
...
@interface Example05YYWeiboUser : NSObject <NSCoding, NSCopying>
