//
//  Example0331Group108Cell.m
//  Example
//
//  Created by Xezun on 2023/8/20.
//

#import "Example0331Group108Cell.h"
#import "Example0331Group108CellViewModel.h"

@interface Example0331Group108Cell ()
@property (nonatomic, strong) UILabel *textLabel;
@property (nonatomic, strong) UILabel *detailTextLabel;
@end

@implementation Example0331Group108Cell

+ (void)load {
    XZMocoa(@"https://mocoa.xezun.com/examples/03/31/collection/108").viewClass = self;
}
