//
//  XZMocoaGridPlaceholderViewModel.m
//  XZKit
//
...
#if DEBUG
@implementation XZMocoaGridPlaceholderViewModel

- (instancetype)initWithModel:(XZMocoaGridCellViewModel *)model {
...
- (void)prepare {
    ...
    XZMocoaGridSectionViewModel * const superViewModel = viewModel.superViewModel;
