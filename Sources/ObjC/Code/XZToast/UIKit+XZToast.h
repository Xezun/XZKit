...
- (nullable XZToastTask *)xz_showToast:(XZToast *)toast duration:(NSTimeInterval)duration position:(XZToastPosition)position exclusive:(BOOL)exclusive completion:(nullable XZToastCompletion)completion NS_SWIFT_DISABLE_ASYNC NS_SWIFT_NAME(__showToast(_:duration:position:exclusive:completion:));
