//
//  XZNavigationController.TransitionController.swift
//  XZKit
//
...
extension XZNavigationController {
    ...
    public final class TransitionController: NSObject {
        ...
        public private(set) var interactiveAnimationController: XZNavigationController.AnimationController?
    }
    
}

extension XZNavigationController.TransitionController: UINavigationControllerDelegate {
    ...
    public func navigationController(_ navigationController: UINavigationController, animationControllerFor operation: UINavigationController.Operation, from fromVC: UIViewController, to toVC: UIViewController) -> UIViewControllerAnimatedTransitioning? {
        ...
        // 普通的动画转场。
        return XZNavigationController.AnimationController.init(for: self.navigationController, operation: operation, isInteractive: false)
    }
    ...
    public func navigationController(_ navigationController: UINavigationController, interactionControllerFor animationController: UIViewControllerAnimatedTransitioning) -> UIViewControllerInteractiveTransitioning? {
        ...
        return (animationController as? XZNavigationController.AnimationController)?.interactionController
    }
    ...
    public func navigationController(_ navigationController: UINavigationController, didShow viewController: UIViewController, animated: Bool) {
        ...
        if animated {
            ...
            // 非动画转场的处理。
            navigationController.navigationBar.customizedBar = (viewController as? XZNavigationBarCustomizable)?.navigationBarIfLoaded
        }
...
extension XZNavigationController.TransitionController {
    ...
    private func interactiveNavigationGestureRecognizerDidBegin(_ panGestureRecognizer: UIPanGestureRecognizer) {
        ...
        case .push:
            // 默认情况下，不可以导航到下一级。
            guard let drivableViewController = navigationController.topViewController as? XZNavigationGestureDrivable else { return }
            ...
            /// 手势开始的导航行为。
            self.interactiveAnimationController = XZNavigationController.AnimationController.init(for: navigationController, operation: operation, isInteractive: true)
...
extension XZNavigationController.TransitionController: UIGestureRecognizerDelegate {
    ...
    public func gestureRecognizer(_ gestureRecognizer: UIGestureRecognizer, shouldRecognizeSimultaneouslyWith otherGestureRecognizer: UIGestureRecognizer) -> Bool {
        ...
        if let topViewController = navigationController.topViewController as? XZNavigationGestureDrivable,
