//
//  XZMocoaGroupSectionViewModel.h
//  XZMocoa
//
...
@class XZMocoaGroupViewModel;

NS_ASSUME_NONNULL_BEGIN

@interface XZMocoaGroupSectionViewModel : XZMocoaViewModel <XZMocoaGroupViewModel>
...
- (NSInteger)indexOfCellViewModel:(__kindof XZMocoaGroupCellViewModel *)cellViewModel;

- (XZMocoaGroupCellViewModel *)removeCellViewModelAtIndex:(NSInteger)index XZ_PRIVATE;
- (void)insertCellViewModel:(XZMocoaGroupCellViewModel *)cellViewModel atIndex:(NSInteger)index XZ_PRIVATE;
...
@interface XZMocoaGroupSectionViewModel (XZMocoaGroupSectionModelTransformer)
