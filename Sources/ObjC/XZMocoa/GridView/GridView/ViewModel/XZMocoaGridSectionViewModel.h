...
@interface XZMocoaGridSectionViewModel : XZMocoaViewModel <XZMocoaGridViewModel>
...
- (nullable __kindof XZMocoaGridSupplementaryViewModel *)viewModelForSupplementaryElementOfKind:(XZMocoaKind)kind atIndex:(NSInteger)index;
/// 直接返回了内部对象，外部请勿修改，使用请自行 copy 。
@property (nonatomic, readonly) NSDictionary<XZMocoaKind, NSArray<__kindof XZMocoaGridSupplementaryViewModel *> *> *supplementaryViewModels;

@property (nonatomic, copy, readonly) NSArray<__kindof XZMocoaGridCellViewModel *> *cellViewModels;
...
- (NSInteger)indexOfCellViewModel:(__kindof XZMocoaGridCellViewModel *)cellViewModel;

- (XZMocoaGridCellViewModel *)removeCellViewModelAtIndex:(NSInteger)index XZ_PRIVATE;
- (void)insertCellViewModel:(XZMocoaGridCellViewModel *)cellViewModel atIndex:(NSInteger)index XZ_PRIVATE;
...
@interface XZMocoaGridSectionViewModel (XZMocoaGridSectionModelTransformer)
