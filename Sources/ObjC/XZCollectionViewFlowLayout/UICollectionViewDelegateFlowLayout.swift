...
public protocol UICollectionViewDelegateFlowLayout: UIKit.UICollectionViewDelegateFlowLayout {
    ...
    /// - Returns: 行对齐方式。
    func collectionView(_ collectionView: UIKit.UICollectionView, layout collectionViewLayout: UIKit.UICollectionViewLayout, lineAlignmentForLineAt indexPath: XZKit.UICollectionViewIndexPath) -> XZKit.UICollectionViewFlowLayout.LineAlignment
    ...
    /// - Returns: 元素对齐方式。
    func collectionView(_ collectionView: UIKit.UICollectionView, layout collectionViewLayout: UIKit.UICollectionViewLayout, interitemAlignmentForItemAt indexPath: XZKit.UICollectionViewIndexPath) -> XZKit.UICollectionViewFlowLayout.InteritemAlignment
    ...
    /// - Returns: 内边距。
    func collectionView(_ collectionView: UIKit.UICollectionView, layout collectionViewLayout: UIKit.UICollectionViewLayout, edgeInsetsForSectionAt section: Int) -> UIEdgeInsets
}
