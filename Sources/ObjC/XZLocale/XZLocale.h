...
///  
/// 在本地化字符串中，支持使用 {1}、{2}、{3} 作为参数占位符，其中的数字表示参数的顺序，若不指定参数类型，参数必须为对象。
///
...
///   - value: 默认字符
/// - Returns: 已本地化的字符串
+ (NSString *)localizedStringForKey:(NSString *)key value:(nullable NSString *)value table:(nullable NSString *)table bundle:(nullable NSBundle *)bundle, ...;
