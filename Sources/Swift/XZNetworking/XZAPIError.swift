...
extension APIError {
    ...
    /// 错误码 -4 ，请求超截止时间，非网络响应的 timeout 超时。
    public static let timeOver = APIError(code: -4, message: "The request is out of the limited time.")
...
public struct APIError: Error, CustomStringConvertible {
    ...
    public struct UserInfoKey: RawRepresentable, ExpressibleByStringLiteral, Hashable, Sendable {
...
extension APIError {
    ...
    public static let Domain = "com.xezun.XZKit"
