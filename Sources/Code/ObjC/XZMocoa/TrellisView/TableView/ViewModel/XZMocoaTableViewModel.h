...
#import <XZKit/XZMocoaTableViewSectionViewModel.h>
...
/// 视图模型发送的事件。
NS_SWIFT_UI_ACTOR @protocol XZMocoaTableViewModelDelegate <XZMocoaTrellisViewModelDelegate>
...
@interface XZMocoaTableViewModel : XZMocoaTrellisViewModel
