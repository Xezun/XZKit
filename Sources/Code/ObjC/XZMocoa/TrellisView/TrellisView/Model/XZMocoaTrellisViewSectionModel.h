//
//  XZMocoaTrellisViewSectionModel.h
//  XZMocoa
//
...
@protocol XZMocoaTrellisViewSectionModel <XZMocoaModel>
...
@interface NSObject (XZMocoaTrellisViewSectionModel)
@end

@interface NSArray (XZMocoaTrellisViewSectionModel)
@end
