//
//  XZMocoaTrellisViewSectionViewModel.h
//  XZMocoa
//
...
@class XZMocoaTrellisViewModel;

NS_ASSUME_NONNULL_BEGIN

@interface XZMocoaTrellisViewSectionViewModel : XZMocoaViewModel <XZMocoaTrellisViewModel>

@property (nonatomic, readonly, nullable) __kindof XZMocoaTrellisViewModel *superViewModel;
...
- (nullable __kindof XZMocoaTrellisViewSupplementaryViewModel *)viewModelForSupplementaryElementOfKind:(XZMocoaKind)kind atIndex:(NSInteger)index;
/// 直接返回了内部对象，外部请勿修改，使用请自行 copy 。
@property (nonatomic, readonly) NSDictionary<XZMocoaKind, NSArray<__kindof XZMocoaTrellisViewSupplementaryViewModel *> *> *supplementaryViewModels;

@property (nonatomic, copy, readonly) NSArray<__kindof XZMocoaTrellisViewCellViewModel *> *cellViewModels;
...
- (NSInteger)indexOfCellViewModel:(__kindof XZMocoaTrellisViewCellViewModel *)cellViewModel;

- (XZMocoaTrellisViewCellViewModel *)removeCellViewModelAtIndex:(NSInteger)index XZ_PRIVATE;
- (void)insertCellViewModel:(XZMocoaTrellisViewCellViewModel *)cellViewModel atIndex:(NSInteger)index XZ_PRIVATE;
...
@interface XZMocoaTrellisViewSectionViewModel (XZMocoaTrellisViewSectionModelTransformer)
