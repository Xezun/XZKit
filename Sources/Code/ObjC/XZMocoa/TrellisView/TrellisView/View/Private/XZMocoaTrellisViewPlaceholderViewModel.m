//
//  XZMocoaTrellisViewPlaceholderViewModel.m
//  XZKit
//
...
#if DEBUG
@implementation XZMocoaTrellisViewPlaceholderViewModel

- (instancetype)initWithModel:(XZMocoaTrellisViewCellViewModel *)model {
...
- (void)prepare {
    ...
    XZMocoaTrellisViewSectionViewModel * const superViewModel = viewModel.superViewModel;
