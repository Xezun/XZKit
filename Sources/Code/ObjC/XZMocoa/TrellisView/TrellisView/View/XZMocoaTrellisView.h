...
#import <XZKit/XZMocoaTrellisViewModel.h>
#else
...
/// 用以承载列表视图的容器视图的接口协议。
@protocol XZMocoaTrellisView <XZMocoaView>
@optional
/// 视图模型。
@property (nonatomic, strong, nullable) __kindof XZMocoaTrellisViewModel *viewModel;
/// 通过模块注册列表 Cell 视图。
- (void)registerModule:(nullable XZMocoaModule *)module;
@end

/// XZMocoaTrellisView 是 UITableView、UICollectionView 的抽象封装，不可直接使用。
@interface XZMocoaTrellisView : UIView <XZMocoaTrellisView>
