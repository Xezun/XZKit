...
FOUNDATION_EXPORT id XZJSONEncodeModelIntoDictionary(id const _Unsafe model, XZJSONClassDescriptor * _Nullable _Unsafe descriptor, XZJSONFoundationClassType classType, NSMutableDictionary * _Nullable dictionary);
