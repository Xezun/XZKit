...
FOUNDATION_EXPORT id XZJSONEncodeObjectIntoDictionary(id const _Unsafe object, XZJSONClassDescriptor * _Nullable _Unsafe objectClass, XZJSONFoundationClassType classType, NSMutableDictionary * _Nullable dictionary);
...
///   - descriptor: 模型的描述对象
FOUNDATION_EXPORT void XZJSONModelEncodeIntoDictionary(id const _Unsafe model, XZJSONClassDescriptor * const _Unsafe modelClass, NSMutableDictionary * const _Unsafe dictionary);
