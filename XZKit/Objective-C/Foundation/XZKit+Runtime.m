...
Class xz_objc_class_create(Class superClass, NSString *name, BOOL rename, void (^NS_NOESCAPE _Nullable subclassing)(Class newClass)) XZ_OVERLOAD {
...
Class xz_objc_class_create(Class superClass, void (^NS_NOESCAPE _Nullable subclassing)(Class newClass)) XZ_OVERLOAD {
    NSString * const name = [NSString stringWithFormat:@"XZKit.%@", NSStringFromClass(superClass)];
    return xz_objc_class_create(superClass, name, YES, subclassing);
}
