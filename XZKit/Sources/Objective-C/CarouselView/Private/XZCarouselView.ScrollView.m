...
- (instancetype)initWithFrame:(CGRect)frame carouselView:(XZCarouselView *)carouselView pagingOrientation:(XZCarouselViewOrientation)pagingOrientation {
...
- (void)_XZCarouselViewScrollViewDidInitialize:(XZCarouselViewOrientation)pagingOrientation {
    _pagingOrientation = pagingOrientation;
    
    self.alwaysBounceVertical           = (_pagingOrientation == XZCarouselViewOrientationVertical);
    self.alwaysBounceHorizontal         = (_pagingOrientation == XZCarouselViewOrientationHorizontal);
...
- (void)setPagingOrientation:(XZCarouselViewOrientation const)pagingOrientation {
...
- (void)updateTransitionForItemViews:(CGFloat const)transition {
    if (_pagingOrientation == XZCarouselViewOrientationVertical || self.xz_userInterfaceLayoutDirection == UIUserInterfaceLayoutDirectionLeftToRight) {
