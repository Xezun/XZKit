...
@interface _XZCarouselViewItemViewTransitionView : UIView
@end
@interface _XZCarouselViewItemViewZoomingView : UIScrollView
@end
@interface _XZCarouselViewItemViewWrapperView : UIView
@end
@implementation _XZCarouselViewItemViewTransitionView
@end
@implementation _XZCarouselViewItemViewZoomingView
@end
@implementation _XZCarouselViewItemViewWrapperView
@end

@interface _XZCarouselViewItemView ()
/// 提供缩放功能的滚动视图。
...
- (instancetype)initWithFrame:(CGRect)frame pagingOrientation:(XZCarouselViewOrientation)pagingOrientation {
    self = [super initWithFrame:frame];
    if (self) {
        self.clipsToBounds = NO;
        
        _index = XZCarouselViewNotFound;
        _zoomScale  = 1.0;
        _transition = 0.0;
...
- (UIView *)transitionView {
    ...
    _transitionView = [[_XZCarouselViewItemViewTransitionView alloc] initWithFrame:self.bounds];
    _transitionView.backgroundColor = self.backgroundColor;
    _transitionView.clipsToBounds = NO;
    [self addSubview:_transitionView];
    
    if (_zoomingView != nil) {
        [_transitionView addSubview:_zoomingView];
    } else {
        [_transitionView addSubview:self.wrapperView];
    }
    
    return _transitionView;
}

- (UIView *)transitionViewIfLoaded {
    return _transitionView;
}
...
- (UIScrollView *)zoomingView {
    ...
    _zoomingView = [[_XZCarouselViewItemViewZoomingView alloc] initWithFrame:self.bounds];
...
- (UIView *)wrapperView {
    ...
    _wrapperView = [[_XZCarouselViewItemViewWrapperView alloc] initWithFrame:self.bounds];
...
- (void)setBackgroundColor:(UIColor *)backgroundColor {
    ...
    [_transitionView setBackgroundColor:backgroundColor];
}
...
- (void)_XZCarouselViewItemViewLayoutSubviews {
...
- (void)setInteritemSpacing:(CGFloat)interitemSpacing {
    if (_interitemSpacing != interitemSpacing) {
        ...
        [self _XZCarouselViewItemViewUpdateInteritemSpacing:self.bounds];
    }
}
...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView {
    [_delegate _XZCarouselViewItemViewWillBeginDragging:self];
}

- (void)scrollViewDidEndDragging:(UIScrollView *)scrollView willDecelerate:(BOOL)decelerate {
    [_delegate _XZCarouselViewItemViewDidEndDragging:self willDecelerate:decelerate];
}

- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    [_delegate _XZCarouselViewItemViewDidEndDecelerating:self];
}
...
- (void)scrollViewWillBeginZooming:(UIScrollView *)scrollView withView:(nullable UIView *)view {
    ...
    [_delegate _XZCarouselViewItemViewWillBeginZooming:self];
}
...
- (void)scrollViewDidZoom:(UIScrollView *)scrollView {
    ...
    [_delegate _XZCarouselViewItemViewDidZoom:self];
}

- (void)scrollViewDidEndZooming:(UIScrollView *)scrollView withView:(nullable UIView *)view atScale:(CGFloat)scale {
    _zoomingView.bounces = (scale != 1.0);
    
    [_delegate _XZCarouselViewItemViewDidEndZooming:self atScale:scale];
}
