...
@interface _XZCarouselViewScrollView : UIScrollView {
    ...
    XZCarouselViewOrientation _pagingOrientation;
}
...
- (instancetype)initWithFrame:(CGRect)frame carouselView:(XZCarouselView *)carouselView pagingOrientation:(XZCarouselViewOrientation)pagingOrientation NS_DESIGNATED_INITIALIZER;
