...
extension AnyNavigationBar {
    ...
    public func isHiddenDidChange() {
        ...
        xz_objc_msgSendSuper(navigationBar, type(of: navigationBar), v: #selector(setter: UIKit.UINavigationBar.isHidden), b: self.isHidden)
    }
    ...
    public func prefersLargeTitlesDidChange() {
        guard let navigationBar = self.navigationBar else { return }
        xz_objc_msgSendSuper(navigationBar, type(of: navigationBar), v: #selector(setter: UIKit.UINavigationBar.prefersLargeTitles), b: self.prefersLargeTitles)
    }
    ...
    public func isTranslucentDidChange() {
        guard let navigationBar = self.navigationBar else { return }
        xz_objc_msgSendSuper(navigationBar, type(of: navigationBar), v: #selector(setter: UIKit.UINavigationBar.isTranslucent), b: self.isTranslucent)
    }
