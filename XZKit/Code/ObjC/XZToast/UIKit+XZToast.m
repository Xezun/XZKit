...
- (XZToastTask *)xz_showToast:(XZToast *)toast duration:(NSTimeInterval)duration position:(NSDirectionalRectEdge)position offset:(CGFloat)offset exclusive:(BOOL)exclusive completion:(void (^)(BOOL))completion {
...
- (XZToastTask *)xz_showToast:(XZToast *)toast {
    return [self xz_showToast:toast duration:3.0 position:(NSDirectionalRectEdgeBottom) offset:0 exclusive:false completion:nil];
}
