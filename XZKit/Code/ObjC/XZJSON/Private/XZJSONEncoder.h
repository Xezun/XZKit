...
FOUNDATION_EXPORT id XZJSONEncodeObjectIntoDictionary(id const __unsafe_unretained object, XZJSONClassDescriptor * _Nullable __unsafe_unretained objectClass, XZJSONFoundationClass classType, NSMutableDictionary * _Nullable dictionary);
