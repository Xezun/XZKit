...
FOUNDATION_EXPORT id XZJSONEncodeObjectIntoDictionary(id const __unsafe_unretained object, XZJSONClassDescriptor * _Nullable __unsafe_unretained objectClass, XZJSONFoundationClassType classType, NSMutableDictionary * _Nullable dictionary);
...
///   - descriptor: 模型的描述对象
FOUNDATION_EXPORT void XZJSONModelEncodeIntoDictionary(id const __unsafe_unretained model, XZJSONClassDescriptor * const __unsafe_unretained modelClass, NSMutableDictionary * const __unsafe_unretained dictionary);
