...
FOUNDATION_EXPORT id XZJSONEncodeObjectIntoDictionary(id const object, XZJSONClassDescriptor * _Nullable objectClass, XZJSONClassType classType, NSMutableDictionary * _Nullable dictionary);
