...
extension WKWebView {
    ...
    public static let userAgentDefaultUserDefaultKey = "com.mlibai.XZKit.userAgent.default"
    
    /// 在 UserDefaults 中记录已设置的 UserAgent 所用的键。
    public static let userAgentCurrentUserDefaultKey = "com.mlibai.XZKit.userAgent.current"
    ...
    @objc(xz_defaultUserAgent) open class var defaultUserAgent: String {
        get {
            ...
            if let userAgent = UserDefaults.standard.string(forKey: WKWebView.userAgentCurrentUserDefaultKey) {
                objc_setAssociatedObject(self, &AssociationKey.userAgent, userAgent, .OBJC_ASSOCIATION_COPY_NONATOMIC)
                UserDefaults.standard.register(defaults: ["UserAgent": userAgent])
                return userAgent
            }
            if let userAgent = UserDefaults.standard.string(forKey: WKWebView.userAgentDefaultUserDefaultKey) {
                objc_setAssociatedObject(self, &AssociationKey.userAgent, userAgent, .OBJC_ASSOCIATION_COPY_NONATOMIC)
                UserDefaults.standard.register(defaults: ["UserAgent": userAgent])
                return userAgent
            }
            if let userAgent = UIWebView().stringByEvaluatingJavaScript(from: "window.navigator.userAgent") {
                objc_setAssociatedObject(self, &AssociationKey.userAgent, userAgent, .OBJC_ASSOCIATION_COPY_NONATOMIC)
                UserDefaults.standard.register(defaults: ["UserAgent": userAgent])
                UserDefaults.standard.set(userAgent, forKey: WKWebView.userAgentDefaultUserDefaultKey)
                return userAgent
            }
        ...
        set {
            ...
            UserDefaults.standard.set(newValue, forKey: WKWebView.userAgentCurrentUserDefaultKey)
