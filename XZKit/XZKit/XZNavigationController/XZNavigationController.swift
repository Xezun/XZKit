...
@objc open class XZNavigationController: UINavigationController, UINavigationControllerDelegate {
    
    /// 转场控制器。
    public private(set) lazy var transitionController = XZNavigationController.TransitionController.init(for: self)
